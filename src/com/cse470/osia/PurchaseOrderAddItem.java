...
public class PurchaseOrderAddItem extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MRP = (EditText)findViewById(R.id.editText1);
		FK = (TextView) findViewById(R.id.purchaseOrderNo);
	...
	public int getFk() {
		return Integer.parseInt(FK.getText().toString());
	}
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	public void addItem(View v) {
		...
		if (productName.equals("") || category.equals("")) {
			toast = Toast.makeText(this, "Fill up the boxes properly", Toast.LENGTH_LONG);
			toast.show();
			return;
		}
		if (subtotal == 0) {
		...
		try {
			db.addNewItemPurchaseOrder(productName, category, unitPrice, quantity, subtotal, mrp);
	...
	public int getMRP() {
		int mrp;
		String getQ = MRP.getText().toString();
		if (getQ.equals(""))
			return 0;
		mrp = Integer.parseInt(getQ);
		return mrp;
	}
